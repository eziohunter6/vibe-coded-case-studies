...
export const projects: Project[] = [
  {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "The system knew where each user was in the journey. Profile had the data. Drop-offs peaked in the 48-hour gap between scheduling and showroom visit. The homepage just never looked.",
        ],
    ...
    reflection: [
      ...
      "Outcome (A/B validated · 2.5M MAU): −5.14% T2V (Time-to-Visit). +3.6% U2V (User-to-Visit). +3.2% U2D (User-to-Delivery). Uplift deepened further in the funnel — a signal this wasn't surface engagement, but genuine improvement in decision quality. All three downstream metrics moved together.",
  ...
  },
  {
    ...
    reflection: [
      "High-intent comparison behaviour was already present in the system. The opportunity was not to create demand, but to support it with decision architecture.",
      "The A\u2192B\u2192A pattern was the most useful thing the data gave us. It reframed the problem from 'users can't decide' to 'the product isn't helping users who already want to decide.' That reframe changed everything about what we built.",
      "By structuring evaluation around weighted decision variables rather than flat information display, the system reduced cognitive friction for high-intent users and improved downstream qualification across all three key business metrics.",
    ],
  },
  {
    format: "mini",
